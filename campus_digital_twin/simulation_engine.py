...
#     #sim_params = load_sim_params(os.path.dirname(os.path.realpath(__file__))+'../data-generator/simulator_params.yaml')
#     sim_params = load_sim_params(os.path.dirname('data-generator/simulator_params.yaml'))
